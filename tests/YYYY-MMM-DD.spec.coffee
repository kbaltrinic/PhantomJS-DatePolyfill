...
describe 'For a date of the form YYYY MMM D hh:mm:ss', ->
    ...
    describe 'calling new Date(string)', ->
        ...
        before -> 
            referenceDate = new Date('2010-01-09 12:03:34')
    ...
    describe 'calling new Date.parse(string)', ->
        ...
        before -> 
            referenceDate = Date.parse('2010-01-09 12:03:34')
...
describe 'Calling new Date(YYYY, MM, DD)', ->
    ...
    before -> 
        referenceDate = new Date('2010-01-09 00:00:00')
...
describe 'Calling new Date(YYYY, MM, DD hh)', ->
    ...
    before -> 
        referenceDate = new Date('2010-01-09 12:00:00')
...
describe 'Calling new Date(YYYY, MM, DD hh:mm)', ->
    ...
    before -> 
        referenceDate = new Date('2010-01-09 12:03:00')
...
describe 'Calling new Date(YYYY, MM, DD hh:mm:ss)', ->
    ...
    before -> 
        referenceDate = new Date('2010-01-09 12:03:32')
...
describe 'Calling new Date(YYYY, MM, DD hh:mm:ss.sss)', ->
    ...
    before -> 
        referenceDate = new Date('2010-01-09 12:03:32.890')
